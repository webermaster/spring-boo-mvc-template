package com.webermaster.spring.boot.mvc.template.test.suites;

import com.webermaster.spring.boot.mvc.template.test.categories.Integration;
import com.webermaster.spring.boot.mvc.template.test.config.Config;
import com.webermaster.spring.boot.mvc.template.test.util.HeadersFactory;
